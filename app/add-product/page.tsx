...
const page = () => {
    const [createProductFormData, setCreateProductFormData] = useState<AddProductFormData>(
        {
            productname: "",
            description: "",
            price: 0,
    ...
    return (
        <section className='w-full flex flex-col items-center justify-center py-8'>
            <h1 className='uppercase text-2xl font-semibold text-slate-700'>Add Product</h1>
            <CreateProductForm
